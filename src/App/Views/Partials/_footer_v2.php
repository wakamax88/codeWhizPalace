<footer class="text-center bg-dark bottom-0">
    <div class="container text-white py-4 py-lg-5">
        <ul class="list-inline d-flex flex-column justify-content-around align-items-sm-center flex-lg-row" style="width: 100%;">
            <li class="list-inline-item" style="margin: 0px;"><a class="link-light" href="/feature">Feature</a></li>
            <li class="list-inline-item" style="margin: 0px;"><a class="link-light" href="/docs">Docs</a></li>
            <li class="list-inline-item"><a class="link-light" href="/contact">Contact</a></li>
        </ul>
        ...
        <p class="text-muted mb-0">Copyright © alicia-88</p>
    </div>
</footer>
