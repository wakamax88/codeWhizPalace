        ...
        <nav class="mx-auto flex container items-center justify-between py-4" aria-label="Global">
            ...
            <div class="flex lg:gap-x-10">
                ...
                if (isset($_SESSION['account'])) { ?>
                    ...
                    <a href="/signout" class="text-gray-300 hover:text-white transition">
                ...
                <?php } else { ?>
                    <a href="/signin" class="text-gray-300 hover:text-white transition">Login</a>
                    <a href="/signup" class="text-gray-300 hover:text-white transition">Register</a>
                <?php } ?>
            </div>
        </nav>
    </header>
