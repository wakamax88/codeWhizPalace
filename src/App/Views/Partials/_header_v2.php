    ...
    <nav class="navbar navbar-expand-md sticky-top bg-dark bg-opacity-75 py-3" data-bs-theme="dark">
        <div class="container-fluid"><a class="navbar-brand d-flex align-items-center" href="#">
            ...
            <div class="collapse navbar-collapse" id="navcol-5">
                ...
                <div class="btn-group focus-ring d-flex d-sm-flex d-md-inline-flex flex-column flex-md-row" role="group"><a class="btn btn-outline-primary border rounded-0 ms-md-2" role="button" href="/signin">S'identifier</a><a class="btn btn-primary ms-md-2" role="button" href="/signup">S'inscrire</a></div>
            </div>
        </div>
    </nav>